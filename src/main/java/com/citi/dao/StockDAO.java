...
public interface StockDAO {
	...
	// Updates the borrowing rate for the stock identified by the ID passed to the function.
	...
	// Deletes the record of a particular stock identified by the ID passed to the function.
